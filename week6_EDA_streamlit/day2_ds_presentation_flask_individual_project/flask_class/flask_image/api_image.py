...
UPLOAD_FOLDER = os.sep + "static" + os.sep #carga el archivo upload
app = Flask(__name__)
...
def upload_image(): #subir una imagen
    ...
    if file:
        ...
        print(path_to_save)
        flash(str(path_to_save)) #mostrar un mensaje por pantalla
...
def get_shape():
    ...
    """.format(a=rows, b=columns) #formatear un texto
